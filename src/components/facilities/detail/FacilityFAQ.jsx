...
export default function FacilityFAQ({ facility }) {
  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'FAQPage',
    mainEntity: facility.faqs.map((faq) => ({
      '@type': 'Question',
      name: faq.question,
        ...
        <div className="lg:col-span-5">
          <div className="lg:sticky lg:top-36">
            <SectionHeading
              ...
              description={`Common questions about the ${facility.title} at ${hospital.shortName}.`}
            />
            ...
            <div className="mt-8 rounded-3xl bg-white p-6 shadow-card ring-1 ring-primary/10">
              ...
              <p className="mt-1.5 text-[15px] leading-relaxed text-ink">Our team is happy to help. Reach us by phone or WhatsApp.</p>
